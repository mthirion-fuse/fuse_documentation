...
public class testSystem {
	    ...
	    private String request = "myrequest.xml";
	    private String myurl = "http://localhost";
	    ...
	    public void sendRequest() throws Exception {
	        ...
	        InputStream fis = readStream(testIntegration.class.getResourceAsStream(request), encoding);
	        ...
	        LOG.info(res);
	        Assert.assertTrue(res.contains("something"));
	    }
